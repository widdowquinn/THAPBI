...
cmd_pear="pear -f ${Name_of_project}_R1.fq.00.0_0.cor.fastq.gz -r ${Name_of_project}_R2.fq.00.0_0.cor.fastq.gz -o ${working_directory_path}/${Name_of_project}_outfiles/${Name_of_project}_PEAR" 
echo ${cmd_pear}
eval ${cmd_pear}
echo "cmd_pear done"
...
cmd_remove_bar_excess="python ${repository_path}/Python_ITS_scripts/remove_barcodes.py -f ./${Name_of_project}_outfiles/fastqjoin.join.fasta_with_barcodes -l ${left_primer_length} -r ${right_primer_length} --barcode ${barcode_length} --ITS CCACAC -o ./${Name_of_project}_outfiles/temp" 
...
cmd_rewite="python ${repository_path}/Python_ITS_scripts/rewrite_as_fastafile.py -i ./${Name_of_project}_outfiles/temp -o ./${Name_of_project}_outfiles/fastqjoin.join.fasta" 
echo ${cmd_rewite}
eval ${cmd_rewite}
wait
...
cmd_cat="cat ${repository_path}/database_files/${Name_of_ITS_database} ${working_directory_path}/${Name_of_project}_outfiles/fastqjoin.join.fasta > ${working_directory_path}/temp_reads_plus_database_full_names.fasta" 
echo ${cmd_cat}
eval ${cmd_cat}

# python rename the files so the names work in Swarm
echo "8) python rewite as fasta with coded names"
cmd_rename="python ${repository_path}/Python_ITS_scripts/completely_rename_ID.py -f ${working_directory_path}/temp_reads_plus_database_full_names.fasta -d ./${Name_of_project}_outfiles/databse_old_names_to_temp.txt -o ${working_directory_path}/temp_reads_plus_database.fasta" 
echo ${cmd_rename}
eval ${cmd_rename}
wait
...
cmd_cat="cat ./${Name_of_project}_outfiles/databse_old_names_to_temp.txt ${repository_path}/database_files/name_to_species_database.txt > ${working_directory_path}/project_database.txt" 
echo ${cmd_cat}
eval ${cmd_cat}
...
do
	...
	swarm_command="swarm -t ${num_threads} --append-abundance 1 -d ${v} -o ${Name_of_project}_reads_cluseterd_with_phy_ITS_Swarmd${v}_coded.out ${working_directory_path}/temp_reads_plus_database.fasta" 
	echo ${swarm_command}
	eval ${swarm_command}
	wait
	...
	cmd_recode="python ${repository_path}/Python_ITS_scripts/parse_clusters.py -i ${Name_of_project}_reads_cluseterd_with_phy_ITS_Swarmd${v}_coded.out -d ${working_directory_path}/project_database.txt -o ${working_directory_path}/${Name_of_project}_results/${Name_of_project}_reads_cluseterd_with_phy_ITS_Swarmd${v}.RESULTS" 
	echo ${cmd_recode}
	eval ${cmd_recode}
	wait
	...
	cmd_summarise_graphs="python ${repository_path}/Python_ITS_scripts/draw_bar_chart_of_clusters.py -i ${working_directory_path}/${Name_of_project}_results/${Name_of_project}_reads_cluseterd_with_phy_ITS_Swarmd${v}.RESULTS -o temp" 
